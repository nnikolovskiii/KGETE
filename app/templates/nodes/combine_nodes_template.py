...
1. Reason whether there are any other nodes that can be combined to the given node. If there is none, just say it.
2. If there are nodes that can be combined to the given node return them ALL in a list.
...
Instructions:
    - If the node can not be combined with other nodes return can_be_combined = no.
